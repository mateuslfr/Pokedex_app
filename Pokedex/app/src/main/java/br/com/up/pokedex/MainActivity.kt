...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val inputTextSearchPokemon : TextInputEditText = findViewById(R.id.search_pokemon)
        //aplicando event listener no search
    ...
    //função para os detalhes do pokemon
    fun callPokemonDetail(pokemon: Pokemon){
        val intent = Intent(this, PokemonStatsActivity::class.java)
